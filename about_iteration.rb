...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject uses the argument as the default starting point for the accumulation
    # it then accumulates the array given the expression provided and outputs the results
  end
  ...
  #   # code to read 'file'
  #
  # maybe File.open reads forward, so you still have to add code to read each line
  # File.map reads all the lines into an object.
