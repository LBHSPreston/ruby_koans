...
class AboutClassMethods < Neo::Koan
  ...
  # This is really goood to remember!!!!!
  # In C# this while inside class is instance, not class.
  # ------------------------------------------------------------------
  ...
  # The firt way looks shorter so it would be my first choice.
  # However, if there are a number of class methods, the second way migth be useful
  # Because you don't have to write self.method for each definition
