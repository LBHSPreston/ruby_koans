...
class AboutToStr < Neo::Koan
  ...
  # The only difference between CanBeTreatedAsString and CanNotBeTreatedAsString is
  # that CanBeTreatedAsString has an extra method to_str, I guess that is present
  # in all objects that can return a string representation.
